      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-6">
            <Link
              to="/explore"
              className={`flex items-center gap-1 font-medium transition-colors hover:text-primary ${pathname === '/explore' ? 'text-primary' : 'text-muted-foreground'}`}
            >
            ...
            <Link
              to="/favorites"
              className={`flex items-center gap-1 font-medium transition-colors hover:text-primary ${pathname === '/favorites' ? 'text-primary' : 'text-muted-foreground'}`}
            >
